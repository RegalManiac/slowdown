...
A lightweight Minecraft plugin designed for **Folia** servers to prevent "Elytra Bouncing" exploits, specifically on the Nether roof.
...
|--------------------------|--------------------------|------------------|
| `/slowdown <true/false>` | Toggle the limiter       | `slowdown.admin` |
